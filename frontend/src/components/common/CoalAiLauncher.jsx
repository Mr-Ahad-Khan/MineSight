  ...
  return (
    <div className="pointer-events-none fixed bottom-5 right-5 z-40 flex flex-col items-end gap-3 sm:bottom-6 sm:right-6">
      ...
      >
        <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#e5a416] text-[#17232a]">
      ...
      >
        ...
        {!open && (
          <span className="coal-ai-wave coal-ai-wave-two" aria-hidden="true" />
        )}
        {!open && (
          <span
