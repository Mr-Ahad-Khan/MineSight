        ...
        <div className="grid gap-8 md:grid-cols-[1.5fr_1fr_1fr_1.2fr]">
          <div>
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#e5a416] text-[#17232a]">
          ...
          <div>
            <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-[#e5a416]">Support</h3>
            <div className="mt-4 flex flex-col gap-2.5 text-sm text-[#b5c2c1]">
              <a href="mailto:support@coalgovernance.in" className="transition-colors hover:text-white">Contact support</a>
          ...
          <div>
            <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-[#e5a416]">System status</h3>
            <div className="mt-4 inline-flex items-center gap-2 text-sm text-[#83d2c5]">
              <span className="h-2 w-2 rounded-full bg-[#39c7b0]" />
              All systems operational
            </div>
            <p className="mt-3 text-xs text-[#758b8e]">Support hours: Mon-Fri, 09:00-18:00 IST</p>
          </div>
        </div>
