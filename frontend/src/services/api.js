...
// In production API traffic is routed through Vercel's same-origin proxy. This
// keeps the backend URL out of the browser bundle and avoids CORS issues.
...
export const closeViolation = (id, violationId) => api.patch(`/inspections/${id}/violations/${violationId}`)
...
export const updateCompliance = (id, data) => api.put(`/compliances/${id}`, data)
